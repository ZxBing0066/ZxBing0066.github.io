$('#select ul').html(_.template('<%_.each(questions, function(question,index){%> <li index=<%=index%>><%=question.title%></li> <%})%>')({
	questions: questions
}))
$('#select ul li').click(function() {
	...
	if ($('#questions').attr('index') != undefined && !confirm("Are you sure?")) {
		return;
	}
